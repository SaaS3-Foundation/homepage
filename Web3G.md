...
Specifically, the user's request will be sent to the geographical nearest 10 miners which are determined by network latency and each of them should have a good amount of stakes such as the top 100 in the overall stake rank list. 
